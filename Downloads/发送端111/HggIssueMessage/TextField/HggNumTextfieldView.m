...
- (void) createUI
{
   ...
   //标题
    ...
    self.toplabel.frame = CGRectMake(20, 0, 100, 15);
    ...
    //我想要它
    self.numHight = self.textNumView.frame.size.height +  self.textNumView.frame.origin.y+180;
}
...
{    self.buttonAction(textView.text);
    NSLog(@"%@",textView.text);
